              ...
              {rentalView === "initial" && (
                <div className="space-y-4 animate-in fade-in zoom-in-95 duration-300">
                  ...
                  <JoinRequestModal trigger={
                    <Button className="w-full h-16 text-xl font-bold bg-blue-600 hover:bg-blue-500 text-white rounded-2xl shadow-[0_0_30px_rgba(37,99,235,0.2)] hover:shadow-[0_0_40px_rgba(37,99,235,0.4)] transition-all active:scale-[0.98] relative font-outfit">
                      <Mail className="absolute left-6 top-1/2 -translate-y-1/2 w-5 h-5 text-white/80" />
                      <span className="flex items-center justify-between w-full pl-14 pr-0">
